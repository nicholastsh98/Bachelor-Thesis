...
file_path = filedialog.askopenfilename(initialdir='C:/Users/tan_ni/PycharmProjects/TCPgetdata1/datastorage',
...
@app.callback(
    [Output('plot', 'figure'), Output('bandwidth-table', 'data'), Output('index-display', 'children')],
...
def update_plot(selected_index, threshold, toggle_value):
    ...
    return fig, bandwidth_data, index_display
